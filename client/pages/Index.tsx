...
export default function Index() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'rgba(1, 102, 254, 1)' }}>
      <Header />
      ...
      <section className="w-full min-h-[60px] md:h-[78px] bg-gym-gray-light flex flex-wrap items-center justify-center gap-4 md:gap-12 lg:gap-20 px-4 py-4 md:py-0">
        <Link to="/services/group-classes" className="text-gym-gray-dark text-[11px] md:text-[13px] lg:text-[14px] font-body font-bold uppercase text-center hover:text-gym-blue transition-colors whitespace-nowrap">
          Group Classes
        </Link>
        <Link to="/services/personal-training" className="text-gym-gray-dark text-[11px] md:text-[13px] lg:text-[14px] font-body font-bold uppercase text-center hover:text-gym-blue transition-colors whitespace-nowrap">
          Personal Training
        </Link>
        <Link to="/services/crossfit" className="text-gym-gray-dark text-[11px] md:text-[13px] lg:text-[14px] font-body font-bold uppercase text-center hover:text-gym-blue transition-colors whitespace-nowrap">
          Cross fit
        </Link>
        <Link to="/services/less-mills" className="text-gym-gray-dark text-[11px] md:text-[13px] lg:text-[14px] font-body font-bold uppercase text-center hover:text-gym-blue transition-colors whitespace-nowrap">
          Less mills CLasses
        </Link>
      </section>
          ...
          <div className="relative w-full max-w-[852px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8 mb-16 md:mb-24 lg:mb-32">
              ...
              <div className="flex-1 pt-0 md:pt-8">
                <h2 className="text-white text-[32px] md:text-[40px] lg:text-[49px] font-heading mb-3 md:mb-4" style={{ textShadow: '0 0 29px rgba(255, 255, 255, 0.30)' }}>
      ...
      <section className="w-full bg-white py-5 flex flex-col justify-center items-center" style={{ borderStyle: 'none', borderWidth: '1px' }}>
      ...
      <section className="w-full pt-36 pb-14" style={{ backgroundColor: 'rgba(1, 102, 254, 1)', marginBottom: '-2px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '144px 0 56px' }}>
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-[53px] max-w-[918px] mx-auto">
            ...
            <div className="w-full max-w-[271px] mx-auto border border-white">
              ...
              <div className="py-12 px-8">
                <p className="text-white text-[48px] md:text-[56px] lg:text-[60px] font-heading text-center mb-6 md:mb-8" style={{ textShadow: '0 0 25px rgba(255, 255, 255, 0.30)' }}>
                  pkr 11,000
                </p>
              ...
              <div className="bg-white flex items-center justify-center" style={{ height: '37px' }}>
            ...
            <div className="w-full max-w-[271px] mx-auto border border-white md:col-span-2 lg:col-span-1">
              ...
              <div className="py-4 px-8 pb-8">
                ...
                <p className="text-white text-[48px] md:text-[56px] lg:text-[60px] font-heading text-center mb-4 md:mb-6" style={{ textShadow: '0 0 25px rgba(255, 255, 255, 0.30)' }}>
                  pkr 31,000
                </p>
                <p className="text-white text-[11px] font-body font-medium leading-relaxed capitalize mb-6">
              ...
              <div className="bg-white flex items-center justify-center" style={{ height: '38px' }}>
                <p className="text-[#555] text-[11px] font-body uppercase text-center">
                  <span className="font-bold">+ pkr </span>
                  <span className="font-extrabold">6,000</span>
                  <span className="font-bold"> Gym Registration fee</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 mt-8 md:mt-12">
            <p className="text-white text-[17px] md:text-[19px] font-body font-bold uppercase text-center" style={{ textShadow: '0 0 25px rgba(255, 255, 255, 0.30)' }}>
              Click here to View full Plans
            </p>
            <Link to="/membership" className="bg-white h-[36px] md:h-[38px] px-5 md:px-6 flex items-center justify-center hover:bg-gym-gray-light transition-colors">
              <span className="text-gym-gray-dark text-[17px] md:text-[19px] font-body font-bold uppercase">View</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-12 md:py-16 lg:py-20" style={{ backgroundColor: 'rgba(1, 102, 254, 1)', marginTop: '-2px', padding: '64px 0 85px' }}>
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 text-center">
          <h2 className="text-white text-[22px] md:text-[26px] lg:text-[29px] font-body font-semibold capitalize mb-6 md:mb-8" style={{ textShadow: '0 0 19px rgba(255, 255, 255, 0.30)' }}>
            Want to try us out first?
          </h2>
          <Link to="/day-pass" className="inline-block bg-white h-[40px] md:h-[46px] px-8 md:px-12 hover:bg-gym-gray-light transition-colors">
            <span className="text-gym-blue-accent text-[18px] md:text-[20px] lg:text-[22px] font-body font-bold italic uppercase leading-[40px] md:leading-[46px]" style={{ textShadow: '0 0 19px rgba(255, 255, 255, 0.30)' }}>
              Get 1 Day Pass
            </span>
          </Link>
          ...
          <div className="mt-12 md:mt-16 overflow-hidden">
            <h3 
              className="text-white text-[80px] sm:text-[140px] md:text-[200px] lg:text-[281px] font-heading opacity-68 mix-blend-soft-light leading-none"
            >
              Join Now
            </h3>
          </div>
